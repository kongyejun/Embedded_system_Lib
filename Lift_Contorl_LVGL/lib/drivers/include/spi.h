 ...
 * @brief       设置多线配置
 *
 * @param[in]   spi_num                                 SPI总线编号
 * @param[in]   instruction_length                      指令长度
 * @param[in]   address_length                          地址长度
 * @param[in]   wait_cycles                             等待周期数
 * @param[in]   instruction_address_trans_mode          SPI传输模式
 *
 */
